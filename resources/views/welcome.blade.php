                        ...
                        <section class="hero">
                            <div class="container">
                                <div class="hero-inner">
                                    <div class="hero-copy">
                                        <h1 class="hero-paragraph mt-12" style="color: #fff">IBM INTERNSHIP</h1>
                                        <p class="hero-paragraph" style="color: #fff">A project to 
                                            Investigate and develop methods to
                                        ...
                                        <div class="hero-form field field-grouped">
                                            ...
                                            <div class="control">
                                                <a class="button button-primary button-block" href="#">Early access</a>
                                            </div>
                                        </div>
                                    </div>
